...
char SataThermalStatusGetCmd[]	= {0xfa, 0x03, 0x08, 0x01, 0x00, 0x00, 0xfb};
char ThermalStatusGetCmd[]	= {0xfa, 0x03, 0x08, 0x02, 0x00, 0x00, 0xfb};
char FanSpeedGetCmd[]		= {0xfa, 0x02, 0x01, 0x00, 0x00, 0x00, 0xfb};
char FanSpeedSetCmd[]		= {0xfa, 0x02, 0x00, 0x00, 0x00, 0x00, 0xfb};
char FanStopCmd[]			= {0xfa, 0x02, 0x00, 0x00, 0x00, 0x00, 0xfb};
char FanHalfCmd[]			= {0xfa, 0x02, 0x00, 0x50, 0x00, 0x00, 0xfb};
char FanFullCmd[]			= {0xfa, 0x02, 0x00, 0xd2, 0x00, 0x00, 0xfb};
...
char WDateAndTimeCmd[]		= {0xfa, 0x01, 0x08, 0x02, 0x07, 0x17, 0x06,
                               0x21, 0x02, 0x10, 0x09, 0x13, 0xfb};
